  ...
  return (
    ...
    >
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Pet Store Web application is the first one which created while Learning aws amplify STUDIO."
        {...getOverrideProps(
          overrides,
          "Pet Store Web application is the first one which created while Learning aws amplify STUDIO."
        )}
      ></Text>
      <Flex
        gap="24px"
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="All Rights received @M2-SANTHE 2023"
        {...getOverrideProps(overrides, "All Rights received @M2-SANTHE 2023")}
      ></Text>
      <Flex
        gap="16px"
        direction="column"
