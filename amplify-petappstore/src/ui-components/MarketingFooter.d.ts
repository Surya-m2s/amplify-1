...
export declare type MarketingFooterOverridesProps = {
    ...
    "Pet Store Web application is the first one which created while Learning aws amplify STUDIO."?: PrimitiveOverrideProps<TextProps>;
    ...
    "All Rights received @M2-SANTHE 2023"?: PrimitiveOverrideProps<TextProps>;
